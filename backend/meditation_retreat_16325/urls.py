"""meditation_retreat_16325 URL Configuration
...
admin.site.site_header = "Meditation Retreat"
admin.site.site_title = "Meditation Retreat Admin Portal"
admin.site.index_title = "Meditation Retreat Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Meditation Retreat API",
        default_version="v1",
        description="API documentation for Meditation Retreat App",
    ),
    public=True,
